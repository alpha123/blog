...
individual flowers (called disc flowers or disc florets) in the center of the “flower” (capitulum). They still all have
5 petals and look more or less pretty flower-like. In sunflowers this is pretty obvious, but the disc flowers can be
even smaller and more reduced in other genera.

[[./img/capitulum.png]]

Even more surprisingly, what look like the petals of the capitulum are /each their own independent flower/ (known as a
ray flower or ray floret) with its petals fused into one single macro-petal called a ligule.
...
#+BEGIN_EXPORT html
<figcaption>Left: /Chrysanthemum/ (probably /Chrysanthemum × morifolium/) mutated to have few or no disc flowers. Photo credit: [[https://www.inaturalist.org/observations/71173999][thowyn]], CC BY-NC 4.0. Right: /Chrysanthemum × morifolium/ without the mutation. Photo credit: [[https://www.inaturalist.org/observations/65883427][Wai Shing]], CC BY-NC 4.0.</figcaption>
</figure>
#+END_EXPORT
